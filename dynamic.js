...
function sells(){
    ...
    if(bodyTableInventory.firstChild){
        ...
        if(sell.checked && arrayElements.includes(movementCodeProduct.value) === false){
            arrayElements.push(movementCodeProduct.value)
            return innerInventory(bodyTableInventory,movementCodeProduct.value,movementProductName.value,count.value,movementCostUnit.value)
        }
        if(sell.checked && arrayElements.includes(movementCodeProduct.value)){
            ...
            bodyTableInventory.children[positionElement].classList.remove('table-danger')
            bodyTableInventory.children[positionElement].classList.remove('table-warning')
            bodyTableInventory.children[positionElement].classList.remove('table-success')
            if(newStock >= 0 && sell.checked){
                ...
                if(newStock < 0){
                    alert(`Tu stock es de ${element[positionElement].children[3].textContent}`)
                    alertsStock(newStock,positionElement)
...
function buys(){
    ...
    if(buy.checked && arrayElements.includes(movementCodeProduct.value) === false){
...
formInventory.addEventListener('submit',(e)=>{
    ...
    if(arrayElements.includes(registerCodeProduct.value) === false){
        ...
        return innerInventory(bodyTableInventory,registerCodeProduct.value,RegisterProductName.value,stock.value,inventoryCostUnit.value)
    }
